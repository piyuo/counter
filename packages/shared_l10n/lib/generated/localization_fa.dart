...
class LocalizationFa extends Localization {
  ...
  @override
  String get video_sources_file_hint => 'یک ویدیو از دستگاه خود انتخاب کنید';

  @override
  String get video_sources_import_error => 'وارد کردن فایل ویدیو انجام نشد.';

  @override
  String get video_sources_live_stream => 'آدرس پخش زنده';

  @override
  String get video_sources_load_error => 'بارگیری منابع ویدیو انجام نشد.';
  ...
  @override
  String get video_sources_screen_title => 'منابع ویدیو';
