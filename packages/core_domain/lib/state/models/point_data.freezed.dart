...
bool operator ==(Object other) {
  final _this = this as PointData;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PointData&&(identical(other.dx, _this.dx) || other.dx == _this.dx)&&(identical(other.dy, _this.dy) || other.dy == _this.dy));
}
...
int get hashCode {
  final _this = this as PointData;
  return Object.hash(runtimeType,_this.dx,_this.dy);
}

@override
String toString() {
  final _this = this as PointData;
  return 'PointData(dx: ${_this.dx}, dy: ${_this.dy})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,dx,dy);
}
