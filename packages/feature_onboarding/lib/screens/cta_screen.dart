...
class CTAScreen extends StatefulWidget {
  const CTAScreen({super.key});

  @override
  State<CTAScreen> createState() => _CTAScreenState();
}

class _CTAScreenState extends State<CTAScreen> {
                ...
                child: CupertinoButton.filled(
                  ...
                  onPressed: _selection == null
                      ...
                      : () {
                          ...
                          return;
                          Navigator.of(context).push(CupertinoPageRoute(builder: (_) => const InvitationScreen()));
                        },
                  child: Text(
