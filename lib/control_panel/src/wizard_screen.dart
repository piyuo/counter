                    ...
                    children: [
                      CupertinoListTile(
                        ...
                        onTap: () {
                          Navigator.of(
                            context,
                          ).pushNamed(openProjectRoute, arguments: {'previousPageTitle': pageTitle});
                        },
                      ),
                    ],
                  ),
                  CupertinoListSection(
                    ...
                    children: [
                      CupertinoListTile(
                        ...
                        trailing: CupertinoListTileChevron(),
                        onTap: () {
                          Navigator.of(context).pushNamed(aboutRoute, arguments: {'previousPageTitle': pageTitle});
                        },
                      ),
                      CupertinoListTile(
                        ...
                        trailing: CupertinoListTileChevron(),
                        onTap: () {
                          Navigator.of(context).pushNamed(languageRoute, arguments: {'previousPageTitle': pageTitle});
                        },
                      ),
                      CupertinoListTile(
