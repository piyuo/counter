      ...
      CupertinoListTile(
        ...
        onTap: () async {
          ...
          try {
            ...
            await projectProvider.newProject(mediaType: vision.SourceType.webcam, projectId: app.uuid());
      ...
      CupertinoListTile(
        ...
        onTap: projectProvider.project != null && projectProvider.project!.hasCameraInVideos
            ...
            : () async {
                ...
                /* debug, temporarily disable camera permission check
                ...
                try {
                  ...
                  await projectProvider.newProject(mediaType: vision.SourceType.camera, projectId: app.uuid());
                  if (context.mounted) {
        ...
        onTap: () async {
          ...
          try {
            ...
            Navigator.of(context).pushNamed(
              ...
              arguments: {
                'nextRouteBuilder': (url) async {
                  projectProvider.newProject(mediaType: vision.SourceType.liveStream, path: url, projectId: app.uuid());
                  return projectRoute;
                },
              },
            );
      ...
      onTap: () async {
        ...
        try {
          ...
          if (isAddMode) {
            ...
            final newFilePath = await saveFileToAppDirectory(filePath, projectProvider.project!.projectId, videoId);
