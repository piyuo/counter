              ...
              child: Column(
                children: [
                  pip.PipHeader(
                    child: Column(
                      children: [
                        ...
                        Text(l.welcome_screen_people_counting, style: const TextStyle(fontSize: 20.0)),
                      ],
                    ),
                  ),
                  ChangeNotifierProvider<VideoStarterProvider>(
                      ...
                      child: Consumer<VideoStarterProvider>(
                          builder: (context, videoStarterProvider, child) => CupertinoListSection(
                                ...
                                header: Text(l.welcome_screen_new_project_from),
                  ...
                  CupertinoListSection(
                    header: Text(l.welcome_screen_title),
                    backgroundColor: pip.getCupertinoListSectionBackgroundColor(context),
                    children: [
                      CupertinoListTile(
                          leading: Icon(CupertinoIcons.globe),
                          title: Text(l.welcome_screen_language),
                      ...
                      CupertinoListTile(
                          ...
                          title: Text(l.welcome_screen_about),
                          trailing: CupertinoListTileChevron(),
                          onTap: () {
