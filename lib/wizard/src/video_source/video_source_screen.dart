              ...
              child: Column(
                children: [
                  CupertinoListSection(
                    ...
                    header: Text(l.video_source_screen_video_name),
                    ...
                    children: [
                      CupertinoTextField(
                        ...
                        placeholder: l.video_source_screen_edit_placeholder,
                  ...
                  // live stream
                  if (video.type == clib.MediaType.live)
                    CupertinoListSection(
                      backgroundColor: pip.getCupertinoListSectionBackgroundColor(context),
                      header: Text(l.video_source_screen_url),
                      children: [
                        CupertinoListTile(
                  ...
                  // file
                  if (video.type == clib.MediaType.file)
                    CupertinoListSection(
                      backgroundColor: pip.getCupertinoListSectionBackgroundColor(context),
                      header: Text(l.video_source_screen_opened_file),
                      children: [
                        CupertinoListTile(
                  ...
                  if (video.type == clib.MediaType.camera)
                    CupertinoListSection(
                      backgroundColor: pip.getCupertinoListSectionBackgroundColor(context),
                      header: Text(l.video_source_screen_camera),
                      children: [
                        CupertinoListTile(
                  ...
                  if (video.type == clib.MediaType.webcam)
                    CupertinoListSection(
                      backgroundColor: pip.getCupertinoListSectionBackgroundColor(context),
                      header: Text(l.video_source_screen_webcam),
                      children: [
                        CupertinoListTile(
                  ...
                  CupertinoListSection(
                    backgroundColor: pip.getCupertinoListSectionBackgroundColor(context),
                    header: Text(l.video_source_screen_zones),
                    footer: Text(l.video_source_screen_zones_desc),
                  ...
                  if (video.type == clib.MediaType.file)
                    CupertinoListSection(
                      backgroundColor: pip.getCupertinoListSectionBackgroundColor(context),
                      header: Text(l.video_source_screen_playback_speed),
                      footer: Text(
                          '${l.video_source_screen_playback_current}${videoProvider.visionController.playbackSpeed}x'),
                      children: [
                        CupertinoListTile(
                            leading: Text(l.video_source_screen_playback_14x),
                            trailing: Text(l.video_source_screen_playback_2x),
                    ...
                    children: [
                      CupertinoListTile(
                        title: Center(
                          ...
                          child: Text(l.video_source_screen_Remove, style: TextStyle(color: CupertinoColors.systemRed)),
                        )),
                      )
                    ],
                  ),
...
class VideoSourceScreenProvider with ChangeNotifier {
  VideoSourceScreenProvider({
    ...
    videoNameController.text = videoProvider.video.name;
  }
