...
/// https://cdn-001.whatsupcams.com/hls/hr_krapina01.m3u8
        ...
        builder: (context, urlScreenProvider, child) {
          return PopScope(
            ...
            onPopInvokedWithResult: (bool didPop, result) async {
              ...
              if (widget.initialUrl.isEmpty || widget.initialUrl == url) {
                        ...
                        onPressed: () async {
                          ...
                          if (context.mounted && ok) {
                            if (widget.nextRouteBuilder != null) {
                              String nextRoute = await widget.nextRouteBuilder!(url);
                              if (context.mounted) {
