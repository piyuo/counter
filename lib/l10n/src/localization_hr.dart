...
class LocalizationHr extends Localization {
  ...
  String get benchmark_screen_start_failed =>
      'Neuspješno pokretanje testiranja, kôd pogreške je';
  ...
  String get counter_screen_cooldown_desc =>
      'Ponovni ulazak zahtijeva #0 sekundi hlađenja nakon izlaska iz zone detekcije';
  ...
  String get counter_screen_enabled_error_content =>
      'Prvo morate omogućiti drugi brojač, zatim možete onemogućiti ovaj brojač';
  ...
  String get counter_screen_reentry_desc =>
      'Objekti moraju ući #0 puta, s #1 sekundi hlađenja između svakog izlaska i ponovnog ulaska, kako bi pokrenuli ponovno brojanje';
  ...
  String get counter_screen_stagnant_desc =>
      'Objekti koji ostanu nepomični više od #0 sekundi smatrat će se stagniranima';
  ...
  String get detection_screen_confidence_desc =>
      'pouzdanost iznad #0 smatra se valjanom detekcijom';
  ...
  String get detection_screen_consider_valid_desc =>
      'Praćeni objekt smatrat će se valjanim nakon #0';
  ...
  String get detection_screen_lost_desc =>
      'Dinamički određuje vrijeme uklanjanja izgubljenih objekata između #0 i #1 na temelju brzine kretanja';
  ...
  String get detection_screen_match_desc =>
      '#0 matchThreshold je ključni parametar u praćenju objekata koji mjeri stupanj podudaranja između različitih okvira detekcije. Niža vrijednost olakšava povezivanje objekata ali povećava rizik od pogrešnih povezivanja. Viša vrijednost je stroža kod povezivanja objekata ali može propustiti neka stvarna podudaranja.';
  ...
  String get detection_screen_reset_content =>
      'Jeste li sigurni da želite resetirati postavke detekcije?';
  ...
  String get error_content =>
      'Došlo je do neočekivane pogreške. Želite li poslati izvješće putem e-maila?';
  ...
  String get filter_screen_desc =>
      'Odaberite raspon filtera s popisa u nastavku';
  ...
  String get objects_screen_desc =>
      'Odaberite ciljeve detekcije poput osobe, automobila, autobusa, itd.';
  ...
  String get open_project_screen_desc =>
      'Otvorite prethodno kreirane projekte, zadržavajući samo najnovijih 20.';
  ...
  String get product_desc =>
      'Korištenje računalnog vida i umjetne inteligencije za brojanje ljudi, vozila, kućnih ljubimaca i više.';
  ...
  String get project_screen_exit_confirm_content =>
      'Napuštanje projekta zaustavit će brojanje. Jeste li sigurni da želite nastaviti?';
  ...
  String get project_screen_from_desc =>
      'Čuvamo 24-satnu evidenciju, tako da možete pregledati bilo koji vremenski odsječak koji trebate.';
  ...
  String get settings_screen_center_point_button =>
      'Prikaži središnju točku na meti';

  @override
  String get settings_screen_center_point_desc =>
      'Središnja točka pomaže odrediti je li meta unutar zone detekcije.';
  ...
  String get settings_screen_desc =>
      'Postavite naziv projekta, parametre detekcije, brisanje brojanja.';
  ...
  String get settings_screen_lost_target_desc =>
      'Kada praćenje objekta izgubi metu, ova opcija je čini vidljivom. Prema zadanim postavkama, izgubljene mete nisu prikazane.';
  ...
  String get settings_screen_project_error =>
      'Naziv projekta ne može biti prazan';
  ...
  String get settings_screen_reset_count_content =>
      'Jeste li sigurni da želite resetirati sva brojanja?';

  @override
  String get settings_screen_reset_count_header =>
      'Resetiraj sva brojanja u ovom projektu';
  ...
  String get url_screen_url_placeholder =>
      'http://primjer.com/stream ili rtsp://primjer.com/stream';
  ...
  String get video_screen_delete_content =>
      'Jeste li sigurni da želite izbrisati ovaj video izvor?';
  ...
  String get video_screen_desc =>
      'Upravljajte video izvorima, dodajte ili modificirajte zone detekcije.';
  ...
  String get video_screen_edit_placeholder =>
      'Kamera na ulaznim vratima ili Kamera na parkiralištu';
  ...
  String get video_screen_name_empty =>
      'Naziv video izvora ne može biti prazan.';
  ...
  String get video_screen_sources =>
      'Konfiguriraj izvor slike, ciljeve detekcije i parametre modela.';
  ...
  String get video_screen_zones_desc =>
      'Koristite povuci i ispusti za prilagodbu zona';
  ...
  String get video_sources_camera_denied_msg =>
      'Idite u postavke i dozvolite pristup kameri za ovu aplikaciju.';

  @override
  String get video_sources_camera_not_found_message =>
      'Potrebno je odobriti dozvolu za pristup kameri';
  ...
  String get video_sources_photos_denied_msg =>
      'Idite u postavke i dozvolite pristup fotografijama za ovu aplikaciju.';

  @override
  String get video_sources_photos_goto_settings => 'Idi u postavke';
  ...
  String get video_sources_webcam_not_found_message =>
      'Provjerite dozvolu aplikacije i povezivanje kamere';

  @override
  String get video_sources_webcam_not_found_title =>
      'Web kamera nije pronađena';
  ...
  String get wizard_screen_desc =>
      'Izradite novi projekt u nastavku za početak brojanja.';
  ...
  String get wizard_screen_open_projects_tip =>
      'Svi projekti automatski će se spremiti lokalno';
  ...
  String get zone_screen_delete_content =>
      'Jeste li sigurni da želite izbrisati ovu zonu?';
  ...
  String get zone_screen_desc =>
      'Zona detekcije može postaviti vrste objekata za detekciju i odabrati koje brojače prikazati, poput Otkriveno, Stvoreno i Ušlo.';

  @override
  String get zone_screen_name_placeholder =>
      'Naziv zone, poput Pločnik ili Parkiralište';
  ...
  @override
  String get zone_screen_zone_show_summary => 'Prikaži sažetak na zaslonu';
}
