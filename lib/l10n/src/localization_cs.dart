...
class LocalizationCs extends Localization {
  ...
  String get product_desc =>
      'Využívá počítačové vidění a umělou inteligenci k počítání osob, vozidel, domácích mazlíčků a dalších objektů.';
  ...
  String get video_sources_camera_not_found_message =>
      'Pro použití kamery je nutné udělit povolení';
  ...
  String get video_sources_webcam_not_found_message =>
      'Zkontrolujte povolení aplikace a připojení kamery';
  ...
  String get wizard_screen_open_projects_tip =>
      'Všechny projekty se automaticky ukládají lokálně';
  ...
  String get benchmark_screen_start_failed =>
      'Spuštění benchmarku selhalo, kód chyby je';
  ...
  String get project_screen_exit_confirm_content =>
      'Opuštění projektu zastaví počítání. Opravdu chcete pokračovat?';
  ...
  String get project_screen_from_desc =>
      'Udržujeme klouzavý 24hodinový záznam, takže můžete zobrazit jakýkoliv časový úsek.';
  ...
  String get settings_screen_desc =>
      'Nastavení názvu projektu, parametrů detekce, vynulování počítadel.';
  ...
  String get settings_screen_project_name_place_holder =>
      'Hlavní 123 nebo Náměstí Republiky';
  ...
  String get settings_screen_reset_count_header =>
      'Vynulovat všechna počítadla v tomto projektu';
  ...
  String get settings_screen_reset_count_content =>
      'Opravdu chcete vynulovat všechna počítadla?';
  ...
  String get settings_screen_center_point_desc =>
      'Středový bod pomáhá určit, zda se cíl nachází v zóně zásahu.';

  @override
  String get settings_screen_center_point_button =>
      'Zobrazit středový bod na cíli';
  ...
  String get settings_screen_lost_target_desc =>
      'Když sledování objektů ztratí cíl, tato možnost ho zviditelní. Ve výchozím nastavení nejsou ztracené cíle zobrazeny.';
  ...
  String get detection_screen_confidence_desc =>
      'jistota nad #0 je považována za platnou detekci';
  ...
  String get detection_screen_nms_desc =>
      '#0 Nižší práh NMS (např. 0.3-0.4) přísněji odstraňuje překrývající se rámečky a snižuje falešně pozitivní výsledky ale může přehlédnout překrývající se osoby. Vyšší práh (0.7-0.9) zachovává více rámečků což může zvýšit falešně pozitivní výsledky ale lépe detekuje překrývající se osoby.';
  ...
  String get detection_screen_match_desc =>
      '#0 matchThreshold je klíčový parametr ve sledování objektů který měří míru shody mezi různými detekčními rámečky. Nižší hodnota usnadňuje propojení objektů ale zvyšuje riziko chybných propojení. Vyšší hodnota je při propojování objektů přísnější ale může přehlédnout některé skutečné shody.';
  ...
  String get detection_screen_lost_desc =>
      'Dynamicky určuje čas pro odstranění ztracených objektů mezi #0 a #1 podle rychlosti pohybu';
  ...
  String get detection_screen_consider_valid_desc =>
      'Sledovaný objekt bude považován za platný po #0';
  ...
  String get detection_screen_reset_content =>
      'Opravdu chcete resetovat nastavení detekce?';
  ...
  String get url_screen_url_placeholder =>
      'http://example.com/stream nebo rtsp://example.com/stream';
  ...
  String get video_screen_name_empty =>
      'Název zdroje videa nemůže být prázdný.';

  @override
  String get video_screen_desc =>
      'Správa zdrojů videa, přidávání nebo úprava detekčních zón.';
  ...
  String get video_screen_edit_placeholder =>
      'Kamera u vchodu nebo Kamera na parkovišti';
  ...
  String get video_screen_delete_content =>
      'Opravdu chcete smazat tento zdroj videa?';
  ...
  String get video_screen_sources =>
      'Konfigurace zdroje obrazu, detekčních cílů a parametrů modelu.';
  ...
  String get zone_screen_desc =>
      'Detekční zóna může nastavit typy objektů k detekci a zvolit, která počítadla zobrazit, jako např. Detekováno, Vytvořeno a Vstoupilo.';

  @override
  String get zone_screen_name_placeholder =>
      'Název zóny, např. Chodník nebo Parkoviště';
  ...
  String get zone_screen_one_zone_required =>
      'Je vyžadována alespoň jedna zóna.';
  ...
  String get counter_screen_reentry_desc =>
      'Objekty musí vstoupit #0 krát, s #1 sekundovou prodlevou mezi každým výstupem a opětovným vstupem, aby se spustil opětovný vstup';
  ...
  String get counter_screen_cooldown_desc =>
      'Opětovný vstup vyžaduje #0 sekundovou prodlevu po opuštění detekční zóny';
  ...
  String get counter_screen_stagnant_desc =>
      'Objekty, které zůstávají nehybné více než #0 sekund, budou považovány za stagnující';
  ...
  String get counter_screen_enabled_error_content =>
      'Nejprve musíte povolit jiné počítadlo, pak můžete zakázat toto počítadlo';
  ...
  String get objects_screen_desc =>
      'Zvolte detekční cíle jako osoba, auto, autobus atd.';
  ...
  String get open_project_screen_desc =>
      'Otevřete dříve vytvořené projekty, uchováváme pouze posledních 20.';
  ...
  String get error_content =>
      'Došlo k neočekávané chybě. Chcete odeslat hlášení e-mailem?';
  ...
  String get video_sources_photos_denied_msg =>
      'Přejděte do nastavení a povolte přístup k fotografiím pro tuto aplikaci.';

  @override
  String get video_sources_camera_denied_msg =>
      'Přejděte do nastavení a povolte přístup ke kameře pro tuto aplikaci.';
}
