...
class LocalizationSv extends Localization {
  ...
  String get product_desc =>
      'Använder datorseende och AI för att räkna personer, fordon, husdjur och mer.';
  ...
  String get video_sources_camera_not_found_message =>
      'Du behöver ge kamerabehörighet för att använda kameran';
  ...
  String get video_sources_webcam_not_found_message =>
      'Kontrollera appbehörighet och webbkameraanslutning';

  @override
  String get wizard_screen_desc =>
      'Skapa ett nytt projekt nedan för att börja räkna.';
  ...
  String get wizard_screen_open_projects_tip =>
      'Alla projekt sparas lokalt automatiskt';
  ...
  String get benchmark_screen_start_failed =>
      'Misslyckades med att starta prestandatest, felkoden är';
  ...
  String get project_screen_exit_confirm_title =>
      'Bekräfta avslut av projektet';

  @override
  String get project_screen_exit_confirm_content =>
      'Om du lämnar projektet kommer räkningen att stoppas. Är du säker på att du vill fortsätta?';
  ...
  String get project_screen_from_desc =>
      'Vi sparar en rullande 24-timmarsperiod, så du kan granska valfri tidsperiod vid behov.';
  ...
  String get settings_screen_desc =>
      'Ställ in projektnamn, detekteringsparametrar, räkningsåterställning.';
  ...
  String get settings_screen_project_name_place_holder =>
      'Storgatan 123 eller Folkets Park';
  ...
  String get settings_screen_random_count_button =>
      'Lägg till slumpmässiga räkningar';

  @override
  String get settings_screen_reset_count_header =>
      'Återställ alla räkningar i detta projekt';
  ...
  String get settings_screen_reset_count_content =>
      'Är du säker på att du vill återställa alla räkningar?';
  ...
  String get settings_screen_center_point_desc =>
      'Centralpunkten hjälper till att avgöra om målet befinner sig inom träffzonen.';

  @override
  String get settings_screen_center_point_button =>
      'Visa centralpunkt på målet';
  ...
  String get settings_screen_lost_target_desc =>
      'När objektspårningen tappar ett mål gör detta alternativ det synligt. Som standard visas inte förlorade mål.';
  ...
  String get detection_screen_confidence_desc =>
      'konfidensgrad över #0 betraktas som en giltig detektering';
  ...
  String get detection_screen_nms_desc =>
      '#0 Ett lägre NMS-tröskelvärde (t.ex. 0.3-0.4) tar bort överlappande rutor mer strikt och minskar falska positiva men kan missa överlappande personer. Ett högre tröskelvärde (0.7-0.9) behåller fler rutor vilket kan öka falska positiva men upptäcker överlappande personer bättre.';
  ...
  String get detection_screen_match_desc =>
      '#0 matchThreshold är en nyckelparameter i objektspårning som mäter graden av matchning mellan olika detektionsrutor. Lägre värde gör objektkoppling enklare men ökar risken för felaktiga kopplingar. Högre värde är striktare på objektkopplingar men kan missa vissa sanna matchningar.';
  ...
  String get detection_screen_lost_desc =>
      'Bestämmer dynamiskt tiden för borttagning av förlorade objekt mellan #0 och #1 baserat på rörelsehastighet';
  ...
  String get detection_screen_consider_valid_desc =>
      'Spårat objekt betraktas som giltigt efter #0';
  ...
  String get detection_screen_reset_content =>
      'Är du säker på att du vill återställa detekteringsinställningarna?';
  ...
  String get url_screen_url_placeholder =>
      'http://exempel.com/stream eller rtsp://exempel.com/stream';
  ...
  String get video_screen_desc =>
      'Hantera videokällor, lägg till eller ändra detekteringszoner.';
  ...
  String get video_screen_edit_placeholder =>
      'Ytterdörrskamera eller Parkeringsplatskamera';
  ...
  String get video_screen_zones_desc =>
      'Använd dra och släpp för att justera zoner';
  ...
  String get video_screen_delete_content =>
      'Är du säker på att du vill ta bort denna videokälla?';
  ...
  String get video_screen_sources =>
      'Konfigurera bildkälla, detekteringsmål och modellparametrar.';
  ...
  String get zone_screen_desc =>
      'Detekteringszonen kan ställa in vilka typer av objekt som ska detekteras och välja vilka räknare som ska visas, såsom Detekterade, Skapade och Inkomna.';

  @override
  String get zone_screen_name_placeholder =>
      'Zonens namn, som Trottoar eller Parkering';
  ...
  String get counter_screen_reentry_desc =>
      'Objekt måste komma in #0 gånger, med #1 sekunders nedkylningstid mellan varje utgång och återinträde, för att utlösa återinträde';
  ...
  String get counter_screen_cooldown_desc =>
      'Återinträde kräver #0 sekunders nedkylning efter att ha lämnat detekteringszonen';
  ...
  String get counter_screen_stagnant_desc =>
      'Objekt som förblir stillastående i mer än #0 sekunder kommer att betraktas som stillastående';
  ...
  String get counter_screen_enabled_error_content =>
      'Du måste aktivera en annan räknare först, sedan kan du inaktivera denna räknare';
  ...
  String get objects_screen_desc =>
      'Välj detekteringsmål som person, bil, buss, etc.';
  ...
  String get open_project_screen_desc =>
      'Öppna tidigare skapade projekt, behåller endast de senaste 20.';
  ...
  String get error_content =>
      'Ett oväntat fel uppstod. Vill du skicka en e-postrapport?';
  ...
  String get video_sources_photos_denied_msg =>
      'Gå till inställningar och tillåt bildåtkomst för den här appen.';

  @override
  String get video_sources_camera_denied_msg =>
      'Gå till inställningar och tillåt kameraåtkomst för den här appen.';
}
