...
class AppLocalizationMy extends AppLocalization {
  AppLocalizationMy([String locale = 'my']) : super(locale);

  @override
  String get product_name => 'ဗီဇရှင် ကောင်တာ';

  @override
  String get product_desc => 'ကွန်ပျူတာမျက်စိနှင့် AI ကိုအသုံးပြု၍ လူများ၊ ယာဉ်များ၊ အိမ်မွေးတိရစ္ဆာန်များနှင့် အခြားအရာများကို ရေတွက်ပါ။';
  ...
  @override
  String get video_sources_camera_not_found_message => 'ကင်မရာကိုအသုံးပြုရန် ကင်မရာခွင့်ပြုချက်လိုအပ်သည်';
  ...
  @override
  String get wizard_screen_open_projects_tip => 'စီမံကိန်းအားလုံးကို စက်ထဲတွင် အလိုအလျောက် သိမ်းဆည်းထားမည်';
  ...
  @override
  String get benchmark_screen_start_failed => 'စံပြုတိုင်းတာချက်စတင်ရန် မအောင်မြင်ပါ၊ အမှားကုဒ်မှာ';
  ...
  @override
  String get project_screen_exit_confirm_title => 'စီမံကိန်းမှထွက်ရန် အတည်ပြုပါ';

  @override
  String get project_screen_exit_confirm_content => 'စီမံကိန်းမှထွက်ခွာခြင်းသည် ရေတွက်ခြင်းကို ရပ်တန့်မည်ဖြစ်သည်။ ဆက်လက်လုပ်ဆောင်ရန် သေချာပါသလား။';
  ...
  @override
  String get project_screen_from_desc => 'လိုအပ်သောအချိန်ကို ကြည့်ရှုနိုင်ရန် ၂၄ နာရီ မှတ်တမ်းကို ထိန်းသိမ်းထားပါသည်။';
  ...
  @override
  String get filter_screen_desc => 'အောက်ပါစာရင်းမှ စစ်ထုတ်မည့်အပိုင်းကို ရွေးချယ်ပါ';

  @override
  String get filter_screen_error_title => 'စစ်ထုတ်ရန်';

  @override
  String get filter_screen_error_content => 'အဆုံးအချိန်သည် စတင်ချိန်ထက် ကြီးရမည်';
  ...
  @override
  String get settings_screen_desc => 'စီမံကိန်းအမည်၊ ရှာဖွေမှုသတ်မှတ်ချက်များ၊ ရေတွက်မှုရှင်းလင်းခြင်းတို့ကို သတ်မှတ်ပါ။';
  ...
  @override
  String get settings_screen_project_name_place_holder => 'မင်္ဂလာလမ်း ၁၂၃ သို့မဟုတ် ရွှေတိဂုံဥယျာဉ်';
  ...
  @override
  String get settings_screen_reset_count_header => 'ဤစီမံကိန်းရှိ ရေတွက်မှုအားလုံးကို ပြန်လည်သတ်မှတ်ပါ';

  @override
  String get settings_screen_reset_count_button => 'ရေတွက်မှုများကို ပြန်လည်သတ်မှတ်ပါ';

  @override
  String get settings_screen_reset_count_content => 'ရေတွက်မှုအားလုံးကို ပြန်လည်သတ်မှတ်ရန် သေချာပါသလား။';

  @override
  String get settings_screen_delete_header => 'ဤစီမံကိန်းကို ဖျက်ပါ';

  @override
  String get settings_screen_delete_content => 'ဤစီမံကိန်းကို ဖျက်ရန် သေချာပါသလား။';
  ...
  @override
  String get settings_screen_center_point_desc => 'အလယ်အမှတ်သည် ပစ်မှတ်သည် ထိမှတ်ဇုန်အတွင်း ရှိမရှိ ဆုံးဖြတ်ရာတွင် အထောက်အကူဖြစ်စေသည်။';

  @override
  String get settings_screen_center_point_button => 'ပစ်မှတ်ပေါ်တွင် အလယ်အမှတ်ပြပါ';

  @override
  String get settings_screen_lost_target_title => 'ပျောက်ဆုံးသွားသော ပစ်မှတ်';

  @override
  String get settings_screen_lost_target_desc => 'အရာဝတ္ထုခြေရာခံခြင်းသည် ပစ်မှတ်ပျောက်ဆုံးသောအခါ ဤရွေးချယ်မှုက မြင်သာအောင်ပြုလုပ်ပေးသည်။ ပုံမှန်အားဖြင့် ပျောက်ဆုံးသော ပစ်မှတ်များကို မပြပါ။';

  @override
  String get settings_screen_lost_target_button => 'ပျောက်ဆုံးသွားသော ပစ်မှတ်ကိုပြပါ';
  ...
  @override
  String get detection_screen_confidence_desc => 'ယုံကြည်မှု #0 ထက်ကျော်လွန်လျှင် တရားဝင်ရှာဖွေမှုအဖြစ် သတ်မှတ်သည်';
  ...
  @override
  String get detection_screen_nms_desc => '#0 ပိုမိုနိမ့်သော NMS သတ်မှတ်ချက် (ဥပမာ ၃၀%) သည် ထပ်နေသောဘောင်များကို ပိုမိုတက်ကြွစွာဖယ်ရှားပေးမည်၊ NMS သတ်မှတ်ချက် မြင့်မား (ဥပမာ ၀.၆) လျှင် ထပ်နေမှုကို ပိုမိုခွင့်ပြုမည်';

  @override
  String get detection_screen_match => 'တိုက်ဆိုင်မှု';

  @override
  String get detection_screen_match_desc => 'တိုက်ဆိုင်မှု #0 ထက်ကျော်လွန်လျှင် တူညီသောအရာဝတ္ထုအဖြစ် သတ်မှတ်သည်။';
  ...
  @override
  String get detection_screen_consider_valid_desc => 'ခြေရာခံအရာဝတ္ထုကို #0 နောက်တွင် ခိုင်မာသည်ဟု သတ်မှတ်မည်';

  @override
  String get detection_screen_reset => 'ပြန်လည်သတ်မှတ်ပါ';

  @override
  String get detection_screen_reset_content => 'ရှာဖွေခြင်းဆက်တင်များကို ပြန်လည်သတ်မှတ်ရန် သေချာပါသလား။';
  ...
  @override
  String get url_screen_url_placeholder => 'http://example.com/stream သို့မဟုတ် rtsp://example.com/stream';
  ...
  @override
  String get video_screen_desc => 'ဗီဒီယိုရင်းမြစ်များကို စီမံခန့်ခွဲပါ၊ ရှာဖွေမှုဇုန်များကို ထည့်သွင်းခြင်း သို့မဟုတ် ပြုပြင်ခြင်း။';

  @override
  String get video_screen_video_name => 'ဗီဒီယိုရင်းမြစ်အမည်';

  @override
  String get video_screen_edit_placeholder => 'ရှေ့တံခါးကင်မရာ သို့မဟုတ် ကားရပ်နားကင်မရာ';
  ...
  @override
  String get video_screen_zones_desc => 'ဇုန်များကို ချိန်ညှိရန် ဆွဲချ/ချထားခြင်းကို အသုံးပြုပါ';
  ...
  @override
  String get video_screen_delete_content => 'ဤဗီဒီယိုရင်းမြစ်ကို ဖျက်ရန် သေချာပါသလား။';

  @override
  String get video_screen_delete_button => 'ဖျက်ပါ';

  @override
  String get video_screen_sources => 'ပုံရင်းမြစ်၊ ရှာဖွေမှုပစ်မှတ်နှင့် မော်ဒယ်သတ်မှတ်ချက်များကို စီစဉ်ပါ။';
  ...
  @override
  String get zone_screen_desc => 'ရှာဖွေမှုဇုန်သည် ရှာဖွေရန် အရာဝတ္ထုအမျိုးအစားများကို သတ်မှတ်နိုင်ပြီး ရှာတွေ့ပြီး၊ ပေါ်လာပြီး၊ ဝင်လာပြီးကဲ့သို့ မည်သည့်ကောင်တာများကို ပြရမည်ကို ရွေးချယ်နိုင်သည်။';

  @override
  String get zone_screen_name_placeholder => 'လမ်းဘေး သို့မဟုတ် ကားရပ်နားရန်နေရာကဲ့သို့ ဇုန်၏အမည်';
  ...
  @override
  String get zone_screen_one_zone_required => 'အနည်းဆုံး ဇုန်တစ်ခု လိုအပ်ပါသည်။';
  ...
  @override
  String get counter_screen_reentry_threshold => 'ပြန်လည်ဝင်ရောက်မှုသတ်မှတ်ချက်';

  @override
  String get counter_screen_reentry_desc => 'အရာဝတ္ထုများသည် #0 ကြိမ် ဝင်ရမည်၊ ထွက်သွားပြီး ပြန်ဝင်ရောက်ခြင်းအကြား #1 စက္ကန့် အအေးခံချိန်ဖြင့် ပြန်လည်ဝင်ရောက်မှုကို စတင်နိုင်သည်';
  ...
  @override
  String get counter_screen_cooldown_desc => 'ပြန်လည်ဝင်ရောက်ရန် ရှာဖွေမှုဇုန်မှ ထွက်ခွာပြီးနောက် #0 စက္ကန့် အအေးခံချိန် လိုအပ်သည်';
  ...
  @override
  String get counter_screen_stagnant_desc => '#0 စက္ကန့်ထက်ပိုပြီး မလှုပ်ရှားဘဲနေသော အရာဝတ္ထုများကို ရပ်တန့်နေသည်ဟု သတ်မှတ်မည်';
  ...
  @override
  String get counter_screen_enabled_error_content => 'ဤကောင်တာကို ပိတ်ရန်အတွက် အခြားကောင်တာကို အရင်ဖွင့်ရန် လိုအပ်ပါသည်';

  @override
  String get objects_screen_title => 'အရာဝတ္ထုများ';

  @override
  String get objects_screen_desc => 'လူ၊ ကား၊ ဘတ်စ်ကား စသည်ဖြင့် ရှာဖွေမှုပစ်မှတ်များကို ရွေးချယ်ပါ။';

  @override
  String get open_project_screen_title => 'စီမံကိန်းဖွင့်ပါ';

  @override
  String get open_project_screen_desc => 'ယခင်ဖန်တီးခဲ့သော စီမံကိန်းများကို ဖွင့်ပါ၊ နောက်ဆုံး ၂၀ ခုကိုသာ သိမ်းထားပါသည်။';
  ...
  @override
  String get error_content => 'မမျှော်လင့်ထားသောအမှားတစ်ခု ဖြစ်ပွားခဲ့သည်။ အီးမေးလ်အစီရင်ခံစာတင်သွင်းလိုပါသလား။';
