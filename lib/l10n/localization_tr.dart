...
class LocalizationTr extends Localization {
  ...
  String get product_desc =>
      'Bilgisayarlı görü ve yapay zeka kullanarak insan, araç, evcil hayvan ve daha fazlasını sayın.';
  ...
  String get video_sources_webcam_not_found_message =>
      'Lütfen uygulama izni ve web kamerası bağlantısını kontrol edin';

  @override
  String get wizard_screen_desc =>
      'Saymaya başlamak için aşağıdan yeni bir proje oluşturun.';
  ...
  String get wizard_screen_open_projects_tip =>
      'Tüm projeler otomatik olarak yerel olarak kaydedilecektir';
  ...
  String get benchmark_screen_start_failed =>
      'Kıyaslama başlatılamadı, hata kodu';
  ...
  String get project_screen_exit_confirm_content =>
      'Projeden ayrılmak Sayımı durduracaktır. Devam etmek istediğinizden emin misiniz?';
  ...
  String get project_screen_from_desc =>
      'İhtiyacınız olan herhangi bir zaman dilimini görüntüleyebilmeniz için 24 saatlik kayıt tutuyoruz.';
  ...
  String get filter_screen_desc =>
      'Aşağıdaki listeden bir filtre aralığı seçin';
  ...
  String get settings_screen_desc =>
      'Proje adını, algılama parametrelerini, sayım temizlemeyi ayarlayın.';
  ...
  String get settings_screen_reset_count_header =>
      'Bu projedeki tüm sayımları sıfırla';
  ...
  String get settings_screen_reset_count_content =>
      'Tüm sayımları sıfırlamak istediğinizden emin misiniz?';
  ...
  String get settings_screen_center_point_title =>
      'Hedef Üzerinde Merkez Nokta';

  @override
  String get settings_screen_center_point_desc =>
      'Merkez noktası, hedefin vuruş bölgesinde olup olmadığını belirlemeye yardımcı olur.';

  @override
  String get settings_screen_center_point_button =>
      'Hedef Üzerinde Merkez Noktayı Göster';
  ...
  String get settings_screen_lost_target_desc =>
      'Nesne izleme bir hedefi kaybettiğinde, bu seçenek onu görünür kılar. Varsayılan olarak, kaybolan hedefler gösterilmez.';
  ...
  String get detection_screen_confidence_desc =>
      '#0 üzerindeki güven geçerli bir algılama olarak kabul edilir';
  ...
  String get detection_screen_nms_desc =>
      '#0 Daha düşük NMS eşiği (örn. 0.3-0.4) çakışan kutuları daha katı şekilde kaldırır ve yanlış pozitifleri azaltır ancak çakışan kişileri atlayabilir. Daha yüksek eşik (0.7-0.9) daha fazla kutu tutar bu da yanlış pozitifleri artırabilir ancak çakışan kişileri daha iyi algılar.';
  ...
  String get detection_screen_lost_desc =>
      'Hareket hızına bağlı olarak #0 ile #1 arasında kaybolan nesnelerin kaldırılma süresini dinamik olarak belirler';
  ...
  String get detection_screen_consider_valid_desc =>
      'İzlenen nesne #0 sonra geçerli kabul edilir';
  ...
  String get video_screen_desc =>
      'Video kaynaklarını yönetin, algılama bölgeleri ekleyin veya değiştirin.';
  ...
  String get video_screen_edit_placeholder =>
      'Ön Kapı Kamerası veya Otopark Kamerası';
  ...
  String get video_screen_zones_desc =>
      'Bölgeleri ayarlamak için sürükle ve bırak kullanın';
  ...
  String get video_screen_delete_content =>
      'Bu video kaynağını silmek istediğinizden emin misiniz?';
  ...
  String get video_screen_sources =>
      'Görüntü kaynağını, algılama hedeflerini ve model parametrelerini yapılandırın.';
  ...
  String get zone_screen_desc =>
      'Algılama bölgesi, algılanacak nesne türlerini ayarlayabilir ve Algılanan, Oluşturulan ve Girilen gibi gösterilecek sayaçları seçebilir.';

  @override
  String get zone_screen_name_placeholder =>
      'Kaldırım veya Otopark gibi bölgenin adı';
  ...
  String get counter_screen_reentry_desc =>
      'Nesneler yeniden girişi tetiklemek için #0 kez girmeli, her çıkış ve yeniden giriş arasında #1 saniyelik bir bekleme süresi olmalıdır';
  ...
  String get counter_screen_stagnant_desc =>
      '#0 saniyeden fazla hareketsiz kalan nesneler durağan kabul edilecektir';
  ...
  String get counter_screen_enabled_error_content =>
      'Önce diğer sayacı etkinleştirmeniz gerekiyor, sonra bu sayacı devre dışı bırakabilirsiniz';
  ...
  String get objects_screen_desc =>
      'İnsan, araba, otobüs vb. algılama hedeflerini seçin.';
  ...
  String get open_project_screen_desc =>
      'Önceden oluşturulmuş projeleri açın, yalnızca en son 20 tanesini saklayarak.';
  ...
  String get video_sources_camera_denied_msg =>
      'Lütfen ayarlara gidin ve bu uygulama için kamera erişim izni verin.';
}
