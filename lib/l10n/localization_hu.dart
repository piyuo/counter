...
class LocalizationHu extends Localization {
  ...
  String get product_desc =>
      'Számoljon embereket, járműveket, háziállatokat és egyebeket számítógépes látás és mesterséges intelligencia segítségével.';
  ...
  String get video_sources_webcam_not_found_message =>
      'Ellenőrizze az alkalmazás engedélyét és a kamera csatlakozását';

  @override
  String get wizard_screen_desc =>
      'Hozzon létre új projektet a számlálás megkezdéséhez.';
  ...
  String get wizard_screen_open_projects_tip =>
      'Minden projekt automatikusan mentésre kerül helyileg';
  ...
  String get benchmark_screen_start_failed =>
      'Nem sikerült elindítani a teljesítménytesztet, a hibakód';
  ...
  String get project_screen_exit_confirm_title =>
      'Projekt kilépés megerősítése';

  @override
  String get project_screen_exit_confirm_content =>
      'A projekt elhagyása leállítja a számlálást. Biztosan folytatja?';
  ...
  String get project_screen_from_desc =>
      '24 órás adatot tárolunk, így bármely időszakot megtekintheti.';
  ...
  String get filter_screen_desc =>
      'Válasszon szűrési tartományt az alábbi listából';
  ...
  String get filter_screen_error_content =>
      'A befejezési időnek nagyobbnak kell lennie a kezdési időnél';
  ...
  String get settings_screen_desc =>
      'Állítsa be a projekt nevét, a felismerési paramétereket, a számlálás törlését.';
  ...
  String get settings_screen_project_name_place_holder =>
      'Kossuth utca 123. vagy Városliget';
  ...
  String get settings_screen_random_count_button =>
      'Véletlenszerű számlálások hozzáadása';

  @override
  String get settings_screen_reset_count_header =>
      'Minden számlálás visszaállítása ebben a projektben';
  ...
  String get settings_screen_reset_count_content =>
      'Biztosan visszaállítja az összes számlálást?';
  ...
  String get settings_screen_center_point_desc =>
      'A középpont segít meghatározni, hogy a célpont a találati zónán belül van-e.';

  @override
  String get settings_screen_center_point_button =>
      'Célpont középpontjának megjelenítése';
  ...
  String get settings_screen_lost_target_desc =>
      'Amikor az objektumkövetés elveszít egy célpontot, ez az opció láthatóvá teszi. Alapértelmezés szerint az elveszett célpontok nem láthatók.';

  @override
  String get settings_screen_lost_target_button =>
      'Elveszett célpont megjelenítése';
  ...
  String get detection_screen_confidence_desc =>
      '#0 feletti megbízhatóság érvényes felismerésnek számít';
  ...
  String get detection_screen_nms_desc =>
      '#0 Alacsonyabb NMS küszöbérték (pl. 0.3-0.4) szigorúbban eltávolítja az átfedő dobozokat és csökkenti a hamis pozitívokat de kihagyhat átfedő embereket. Magasabb küszöbérték (0.7-0.9) több dobozt tart meg ami növelheti a hamis pozitívokat de jobban érzékeli az átfedő embereket.';
  ...
  String get detection_screen_lost_desc =>
      'A mozgás sebessége alapján dinamikusan meghatározza az elveszett objektumok eltávolítási idejét #0 és #1 között';

  @override
  String get detection_screen_consider_valid =>
      'Érvényesnek tekintve ennyi után';

  @override
  String get detection_screen_consider_valid_desc =>
      'A követett objektum #0 után érvényesnek tekintendő';
  ...
  String get video_screen_edit_placeholder =>
      'Bejárati ajtó kamera vagy Parkoló kamera';
  ...
  String get video_screen_zones_desc =>
      'Használja a fogd és vidd módszert a zónák beállításához';
  ...
  String get video_screen_remove_point =>
      'Pont eltávolítása a jelenlegi zónából';
  ...
  String get video_screen_delete_content =>
      'Biztosan törölni szeretné ezt a videóforrást?';
  ...
  String get video_screen_sources =>
      'Képforrás, felismerési célpontok és modellparaméterek beállítása.';
  ...
  String get zone_screen_desc =>
      'A felismerési zóna beállíthatja a felismerendő objektumtípusokat és kiválaszthatja, mely számlálók jelenjenek meg, például Felismert, Létrejött és Belépett.';

  @override
  String get zone_screen_name_placeholder =>
      'A zóna neve, például Járda vagy Parkoló';
  ...
  String get counter_screen_reentry_desc =>
      'Az objektumnak #0 alkalommal kell belépnie, minden kilépés és újrabelépés között #1 másodperces várakozási idővel, hogy kiváltsa az újrabelépést';
  ...
  String get counter_screen_stagnant_desc =>
      'A #0 másodpercnél hosszabb ideig egy helyben maradó objektumok mozdulatlannak tekintendők';
  ...
  String get counter_screen_enabled_error_content =>
      'Először engedélyeznie kell egy másik számlálót, csak ezután tilthatja le ezt a számlálót';
  ...
  String get objects_screen_desc =>
      'Válasszon felismerési célpontokat, például személy, autó, busz stb.';
  ...
  String get open_project_screen_desc =>
      'Nyissa meg a korábban létrehozott projekteket, csak a legutóbbi 20 kerül megőrzésre.';
  ...
  String get error_content =>
      'Váratlan hiba történt. Szeretne e-mailes hibajelentést küldeni?';
  ...
  String get video_sources_photos_denied =>
      'Fényképekhez való hozzáférés megtagadva';

  @override
  String get video_sources_photos_goto_settings => 'Beállítások';

  @override
  String get video_sources_camera_denied =>
      'Kamerához való hozzáférés megtagadva';
  ...
  String get video_sources_camera_denied_msg =>
      'Menjen a beállításokhoz és engedélyezze a kamerához való hozzáférést ennek az alkalmazásnak.';
}
