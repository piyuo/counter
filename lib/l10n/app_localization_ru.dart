...
class AppLocalizationRuKz extends AppLocalizationRu {
  AppLocalizationRuKz(): super('ru_KZ');
...
class AppLocalizationRuUa extends AppLocalizationRu {
  AppLocalizationRuUa(): super('ru_UA');
