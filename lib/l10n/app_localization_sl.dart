...
class AppLocalizationSl extends AppLocalization {
  AppLocalizationSl([String locale = 'sl']) : super(locale);
  ...
  @override
  String get video_sources_webcam_not_found_message => 'Preverite, ali je spletna kamera priključena';
