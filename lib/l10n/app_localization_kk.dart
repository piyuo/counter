...
class AppLocalizationKk extends AppLocalization {
  AppLocalizationKk([String locale = 'kk']) : super(locale);
  ...
  @override
  String get detection_screen_nms_desc => '#0 Төменірек NMS шегі (мысалы, 30%) қабаттасатын шекаралық жақтауларды агрессивті түрде жояды, ал жоғарырақ NMS шегі (мысалы, 0.6) көбірек қабаттасуға мүмкіндік береді';
