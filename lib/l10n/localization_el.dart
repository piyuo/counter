...
class LocalizationEl extends Localization {
  ...
  @override
  String get detection_screen_nms_desc => '#0 Χαμηλότερο όριο NMS (π.χ. 0.3-0.4) αφαιρεί τα επικαλυπτόμενα πλαίσια πιο αυστηρά και μειώνει τα ψευδώς θετικά αλλά μπορεί να χάσει επικαλυπτόμενα άτομα. Υψηλότερο όριο (0.7-0.9) διατηρεί περισσότερα πλαίσια που μπορεί να αυξήσει τα ψευδώς θετικά αλλά ανιχνεύει καλύτερα επικαλυπτόμενα άτομα.';
