...
class LocalizationMn extends Localization {
  ...
  @override
  String get detection_screen_nms_desc => '#0 Бага NMS босго (жишээ нь 30%) нь давхцсан хүрээнүүдийг илүү шийдвэртэйгээр устгах бол өндөр NMS босго (жишээ нь 0.6) нь илүү их давхцлыг зөвшөөрнө';
