...
class AppLocalizationFrBe extends AppLocalizationFr {
  AppLocalizationFrBe(): super('fr_BE');
...
class AppLocalizationFrCa extends AppLocalizationFr {
  AppLocalizationFrCa(): super('fr_CA');
...
class AppLocalizationFrCh extends AppLocalizationFr {
  AppLocalizationFrCh(): super('fr_CH');
