...
class AppLocalizationFa extends AppLocalization {
  AppLocalizationFa([String locale = 'fa']) : super(locale);
  ...
  @override
  String get detection_screen_nms_desc => '#0 آستانه NMS پایین‌تر (مثلاً ۳۰٪) به طور جدی‌تری کادرهای هم‌پوشان را حذف می‌کند، در حالی که آستانه NMS بالاتر (مثلاً ۰.۶) هم‌پوشانی بیشتری را اجازه می‌دهد';
