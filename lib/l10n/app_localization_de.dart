...
class AppLocalizationDeAt extends AppLocalizationDe {
  AppLocalizationDeAt(): super('de_AT');
...
class AppLocalizationDeCh extends AppLocalizationDe {
  AppLocalizationDeCh(): super('de_CH');
