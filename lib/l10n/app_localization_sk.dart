...
class AppLocalizationSk extends AppLocalization {
  AppLocalizationSk([String locale = 'sk']) : super(locale);
  ...
  @override
  String get detection_screen_lost_desc => 'Sledovaný objekt bude odstránený, ak je stratený po dobu #0';
