...
`apps/counter_app/release/build_release_notes.txt`

This file is the English (`en-US`) source.

Keep the original `build_release_notes.txt` unchanged.

Create translated UTF-8 `.txt` files in:

`apps/counter_app/release/release_notes/`

First, copy the English source to:

`apps/counter_app/release/release_notes/en-US.txt`
...
- Translate every file directly from `apps/counter_app/release/build_release_notes.txt`.
...
- ✓ The original `apps/counter_app/release/build_release_notes.txt` was **not** modified.
