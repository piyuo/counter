...
`apps/counter_app/release/build_subtitle.txt`

This file is the English (`en-US`) source.

Keep the original `build_subtitle.txt` unchanged.

Create translated UTF-8 `.txt` files in:

`apps/counter_app/release/subtitle/`

First, copy the English source to:

`apps/counter_app/release/subtitle/en-US.txt`
...
- Translate every file directly from `apps/counter_app/release/build_subtitle.txt`.
...
- ✓ The original `apps/counter_app/release/build_subtitle.txt` was **not** modified.
